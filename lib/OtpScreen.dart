...
class _OtpScreenState extends State<OtpScreen> {
  ...
  @override
  void initState() {
    print("main number from otp ${widget.phone}and ${widget.countryCode}");
    verificationCode="";
    setState(() {
      verifyNumber();
    });
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async{
                           try{
                             //Fluttertoast.showToast(msg: otpNo);
                             //await FirebaseAuth.instance.signInWithCredential(EmailAuthProvider.credential(email: "sunil@gmail.com", password: "12345678"));
